...
7. Uncheck all four checkboxes and click Save. NOTE: This step makes objects in your S3 bucket public. We are doing this to reduce few steps in the workshop, but you should not do that for production workloads. Instead it is recommended to use S3 Signed URLs to give time limited access to objects in S3.
